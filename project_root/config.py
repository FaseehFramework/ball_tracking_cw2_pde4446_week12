...
# TRACKING VISUALS
# ============================================================
CIRCLE_RADIUS = 50  # Radius of the center circle drawn on screen
BUFFER_SIZE = 64    # Length of the tracking trail

# ============================================================
# COMMAND THROTTLING
# ============================================================
COMMAND_INTERVAL = 0.7
...
# ============================================================
YOLO_MODEL_PATH = r'D:\VIT_D\MDX\S&MC\cw2\project_root\yolo\my_model\best.pt'
